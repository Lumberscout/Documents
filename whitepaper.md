...
FPs account for 5% of Gross World Product or 4 trillion USD in 2016. Fun fact: if you spent one USD per second, it would take you approximately 126,836 years to reach 4 trillion. According to U.N. statistics, 33% in the world population currently depends on FPs for sustenance. Despite the importance of FPs to the global economy, novelties continue to distract the public imagination. The fact remains: practical implementations of distributed ledgers can revolutionise commodity-based industries. Lumberscout will redefine the FPs sector.
